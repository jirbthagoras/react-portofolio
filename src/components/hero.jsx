    ...
    return (
        ...
        style={{backgroundImage: `url(${cover})`}}>
            ...
            <div className="bg-black bg-opacity-60 h-full flex flex-col justify-center items-center text-center p-6">
                ...
                <p className="text-2xl mb-8">Aku suka <strong className="text-rose-700 bg-white rounded">Laravel</strong> tapi sayangnya ini dibuat make <strong className="text-teal-500 bg-white rounded">React</strong>
                </p>
